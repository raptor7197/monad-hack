...
export function CalculatorSection() {
  ...
  const attackExposure = (tokensM * 0.45).toFixed(2);
  const feeMonad = (tokensM * 0.00008).toFixed(4);
  ...
  return (
    <section id="calculator" className="w-full border-b border-border bg-surface py-16 md:py-24">
      <div className="mx-auto max-w-[1440px] px-6 md:px-16">
        ...
        <div className="mx-auto max-w-4xl rounded-2xl border border-border bg-surface-2 p-6 md:p-12 shadow-2xl">
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <span className="font-mono text-xl md:text-2xl font-bold text-brand">
