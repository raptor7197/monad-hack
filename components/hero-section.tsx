        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-center pointer-events-none">
          <div className="mx-auto w-full max-w-[1440px] px-6 md:px-16 pointer-events-auto">
            <div className="max-w-5xl">
              ...
              <h1
                ref={headingRef}
                className="font-display font-extrabold uppercase leading-[0.88] tracking-[-0.04em] text-ink drop-shadow-md"
              ...
              <p
                ref={subRef}
                className="mt-6 max-w-2xl text-base md:text-xl text-muted leading-relaxed font-normal"
              >
